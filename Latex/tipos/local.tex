\begin{tipo}{Local}
	...
	\invariante[ventasCorrelativas]{\ldots}
	\invariante[combosDeLocal]{(\forall v \selec ventas(l)) (\forall c \selec combos(v)) bebida(c) \in bebidasDelLocal(l) \wedge sandwich(c) \in sandwichesDelLocal(l)}
