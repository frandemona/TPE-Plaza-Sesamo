\begin{tipo}{Local}
	...
	\invariante[ventasCorrelativas]{ \longitud{ \rango{menorNumeroPedido(ventas(l))}{mayorNumeroPedido(ventas(l))}} == \longitud{ ventas(l)} \land (\forall \selector{i}{\rango{menorNumeroPedido(ventas(l))}{mayorNumeroPedido(ventas(l))}},\\ \selector{j}{\rangoca{0}{\longitud{ventas(l)}}}) i == numero(ventas_{j})}
	\invariante[combosDeLocal]{(\forall \selector{i}{sandwichLocal(ventas(l))}, \selector{j}{sandwichesDelLocal(l)}) i == j \land (\forall \selector{i}{bebidaLocal(ventas(l))}, \selector{j}{bebidasDelLocal(l)}) i == j }
