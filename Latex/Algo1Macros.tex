...
{%
  %\usepackage[top=2.5cm,bottom=2cm,width=15cm,height= 24.5cm,left = 3cm]{geometry}%viejo
  \usepackage[top=2.5cm,bottom=2cm,left=1.2cm,right=1.2cm]{geometry}%
  \usepackage{color}%
  \newcommand{\tocarEspacios}{%
...
\def\materias#1{\gdef\@materias{#1}}%viejo comentado
\def\@materias{No especifi\'o la materia}%viejo comentado
\def\lamateria{\@materias}%viejo comentado
